...
def inputt():
    ...
    try:
        ...
        numberOfObstacles = 3
    try:
        showAnnimation = int(input("Enter 1 if you want to show annimation, 0 if you want to see only final path, (default no annimation) =>"))
    except ValueError:
        showAnnimation = 0
    ...
    return iterations, numberofObjects, DroneSize, step, numberOfObstacles, start, goal, obstaclenodes, showAnnimation
