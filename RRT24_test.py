...
print(f"Computational time: {time.process_time() - start}")
for i in range(len(path)):
    print(f"Length of path without smoothing for {i}'s object = {cal_length(path[i])}")
    print(f"Length of path with smoothing for {i}'s object = {cal_length(pathSmooth[i])}")
